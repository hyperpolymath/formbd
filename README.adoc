...
* link:spec/self-normalizing.adoc[Self-Normalizing Database] - Automatic FD discovery, type-encoded normal forms, proof-carrying schema evolution
* link:docs/WP05_interactive_documentary.md[WP05] - FormDB for Interactive Documentary/Journalism
* link:spec/fql-dependent-types.md[FQL Dependent Types] - Compile-time verified query language (see also https://github.com/hyperpolymath/fqldt[fqldt repo])
